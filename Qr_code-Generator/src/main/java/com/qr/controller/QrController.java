...
public class QrController {
	...
	public String genrateQRCode(@ModelAttribute("qr") QrPojo qrPojo, Model model) {
		...
		try {
			...
			File output = new File("C:\\Users\\ankur\\Documents\\workspace-spring-tool-suite-4-4.15.1.RELEASE\\Qr_code-Generator\\src\\main\\resources\\static"+qrPojo.getFirstName()+".jpg");
